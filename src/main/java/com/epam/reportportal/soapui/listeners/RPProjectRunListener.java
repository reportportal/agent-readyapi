...
public class RPProjectRunListener implements ProjectRunListener {
     ...
     * groovy.log logger.
     */
    private void defineLogger(SoapUIService soapUIService) {
        @SuppressWarnings("rawtypes")

        ReportPortalAppender soapUIAppender = new ReportPortalAppender(
                Suppliers.ofInstance((BatchedReportPortalService) soapUIService.getServiceClient()),
                Suppliers.ofInstance(soapUIService.getInjector().getBean(MessageParser.class)));
